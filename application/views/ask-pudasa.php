        ...
        <div class="row align-items-center">
                        ...
                        <form method="post" action="php/contact.php" name="contact-form" id="contact-form">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group position-relative">
                                        ...
                                        <input name="name" id="name" type="text" class="form-control pl-5" placeholder="Nama Anda :">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-lg-6">
                                    <div class="form-group position-relative">
                                        ...
                                        <input name="email" id="email" type="email" class="form-control pl-5" placeholder="Email Anda :">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-lg-12">
                                    <div class="form-group position-relative">
                                        ...
                                        <textarea name="comments" id="comments" rows="4" class="form-control pl-5" placeholder="Pesan Anda :"></textarea>
                                    </div>
                                </div>
                            </div>
                            <!--end row-->
                            <div class="row">
                                <div class="col-sm-12 text-center">
                                    <input type="submit" id="submit" name="send" class="submitBnt btn text-white btn-block" style="background-color: #4E83AB;" value="Kirim Pesan Sekarang">
            ...
            <div class="col-lg-7 col-md-6 order-1 order-md-2">
                <div class="title-heading ml-lg-4">
                    <h4 class="mb-4">Detail Kontak</h4>
