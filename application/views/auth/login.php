...
<body>
    ...
    <div class="back-to-home rounded d-none d-sm-block">
        <a href="<?= base_url(); ?>" class="btn btn-icon text-white" style="background-color: #4E83AB;"><i data-feather="home" class="icons"></i></a>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-8">
                    <div class="card login-page bg-white shadow rounded border-0">
                        <div class="card-body">
                            <h4 class="card-title text-center">Pudasa - Login</h4>
                            <form class="login-form mt-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-0">
                                        <button class="btn text-white btn-block" style="background-color: #4E83AB;">Masuk</button>
                                    </div>
                                    <div class="col-12 text-center">
                                        <p class="mb-0 mt-3"><small class="text-dark mr-2">Belum memiliki akun?</small> <a href="<?= base_url(); ?>Auth/register" class="text-dark font-weight-bold">Daftar disini</a></p>
                                    </div>
                                </div>
                            </form>
                        </div>
