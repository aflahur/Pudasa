		...
		<div class="row justify-content-center">
			<div class="col-lg-12 text-center">
				<div class="page-next-level">
					<h4 class="title"> Checkout Belajar </h4>
					<div class="page-next">
						<nav aria-label="breadcrumb" class="d-inline-block">
							<ul class="breadcrumb bg-white rounded shadow mb-0">
								<li class="breadcrumb-item"><a href="<?= base_url(); ?>">PUDASA</a></li>
								<li class="breadcrumb-item"><a href="<?= base_url(); ?>Belajar">Belajar</a></li>
								<li class="breadcrumb-item active" aria-current="page" style="color: #4E83AB!important;">Checkout Belajar</li>
							</ul>
						</nav>
					</div>
				</div>
				...
				<div class="rounded shadow-lg p-4">
					<div class="table-responsive">
						<table class="table table-center table-padding mb-0">
							<tbody>
								<tr style="background: #f5f6fa; padding: 16px;">
									<td class="h6 border-0">Sanggar Tari Bu Dewi - Tari Daerah Bali</td>
									<td></td>
								</tr>

								<tr style="background: #f5f6fa; padding: 16px;">
									<td class="h6 border-0">Kode Pesanan</td>
									<td class="text-right font-weight-bold border-0">27092020HFBTY</td>

								</tr>
								<tr style="background: #f5f6fa; padding: 16px;">
									<td class="h6 border-0">Tari Pendet</td>
									<td class="text-right font-weight-bold border-0">Rp. 30.000</td>
								</tr>
								<tr>
									<td class="h6">Biaya Pajak</td>
									<td class="text-right font-weight-bold">Rp. 2.000</td>
								</tr>
								<tr class="bg-light">
									<td class="h5 font-weight-bold">Total</td>
									<td class="text-right text-danger h5 font-weight-bold">Rp. 32.000</td>
								</tr>
							</tbody>
						</table>
